...
public class Chamado extends Pessoa {
	...
	@Override
	public int hashCode() {
		return Objects.hash(cliente, dataFechamento, dateAbertura, id, observacoes, prioridade, status, tecnico,
				titulo);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(cliente, other.cliente) && Objects.equals(dataFechamento, other.dataFechamento)
				&& Objects.equals(dateAbertura, other.dateAbertura) && Objects.equals(id, other.id)
